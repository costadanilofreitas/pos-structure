...
const TabsShortcut = (props) => {
  return (
    <svg height="100%" version="1.1" viewBox="0 0 512 512" width="100%" x="0px" y="0px" {...props}>
      <path
        fill={props.fill}
...
TabsShortcut.propTypes = {
  fill: PropTypes.string
}

TabsShortcut.defaultProps = {
  fill: '#898b98'
}

export default TabsShortcut
