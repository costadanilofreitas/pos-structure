...
class RemoteOrderEventHandler(EventHandler):
    def __init__(self, pos_id, mb_context, remote_order_processor, remote_order_pickup_time_updater, order_service,
                 ...
                 max_time_to_cancel_orders, logistic_service, delivery_fee_part_code, delivery_event_repository,
                 use_delivery_fee):
        # type: (int, MBEasyContext, RemoteOrderProcessor, RemoteOrderPickupTimeUpdater, OrderService, StoreService, MenuBuilder, RemoteOrderRuptureUpdater, int, int, int, bool, StoreStatusManager, bool, bool, bool, str, bool) -> None # noqa
    ...
    def _create_production_service(self):
        return ProductionService(self.pos_id,
                                 ...
                                 self.order_service,
                                 self.cancellation_service,
                                 self.delivery_event_repository,
                                 self.event_dispatcher,
    ...
    def handle_message(self, msg):
        ...
        try:
            ...
            if msg.token == BusTokens.TK_REMOTE_ORDER_GET_STORED_ORDERS:
                ...
                logger.info("order %s", orders_json)
