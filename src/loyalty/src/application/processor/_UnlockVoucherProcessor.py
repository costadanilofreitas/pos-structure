from application.interactor import BurnVoucherInteractor, UnlockVoucherInteractor
...
class UnlockVoucherProcessor(AsyncUuidMessageProcessor):
    def __init__(self, configs, interactor):
        # type: (Configurations, UnlockVoucherInteractor) -> None

        super(UnlockVoucherProcessor, self).__init__()
    ...
    def call_business(self, benefit_id):
        ...
        self.interactor.unlock_benefit(benefit_id)
