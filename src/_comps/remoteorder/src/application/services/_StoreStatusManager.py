    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                elapsed_time_between_last_contact = (_now() - self.last_external_contact_timestamp).seconds * 60
                if elapsed_time_between_last_contact > self.limit_of_time_without_external_contact:
