...
class ProductionOrder(CustomStorage):
    ...
    state_history = ()  #: List of StateEvent objects of this order
    items = ()  #: Level-0 items of this order
    properties = ()  #: List of OrderProperties from the Order Picture
    ...
    def prod_state(self, new_state):
        self._prod_state_history.append(StateEvent(prod_state=new_state, timestamp=datetime.now().isoformat()))
