...
_PICKLE_PROTOCOL = 2  # Pickle protocol version to use ("2" is the best one at the time this is written)
...
class ProdPersistException(Exception):
    pass


class OrderNotFoundException(ProdPersistException):
    pass
