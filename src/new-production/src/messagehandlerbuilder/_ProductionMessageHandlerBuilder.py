...
class ProductionMessageHandlerBuilder(MessageHandlerBuilder):
    def __init__(self,
                 ...
                 manager_log_level,
                 audit_logger_prod_states,
                 boxes_config,
                 branches_config,
                 views_config,
                 loggers):
        # type: (MessageBus, int, int, ProductRepository, ProductionRepository, str, List, List[TreeConfig], List[TreeConfig], List[ViewConfiguration], Dict[str, Logger]) -> None  # noqa
    ...
    def build_singletons(self):
        ...
        tree_builder = TreeBuilder(
            ProductionBoxFactory(self.production_manager,
                                 ...
                                 self.loggers),
            ViewFactory(self.message_bus, self.loggers, self.production_manager))
