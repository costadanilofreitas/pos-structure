...
from application.interactor import OrderModifiedReopenedInteractor
...
class OrderModifiedReopenedProcessor(AsyncUuidMessageProcessor):
    
    def __init__(self, interactor):
        # type: (OrderModifiedReopenedInteractor) -> None

        super(OrderModifiedReopenedProcessor, self).__init__()
    ...
    def call_business(self, params):
        ...
        return self.interactor.remove_benefit(pos_id, order_id, order_picture)
