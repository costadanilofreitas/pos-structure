Feature: Mobile Rupture

  Scenario: Mobile - Add item to rupture then remove it
    ...
    And mobile POS QSR-FL-FL selects food category ENTRADAS as ENTRADAS DIVERSAS
  ...
  Scenario: Mobile - Multiple selection
    When user opens POS QSR-FL-FL in mobile
    And POS QSR-FL-FL clicks on the test_Header_MANAGER-MENU
    Then POS QSR-FL-FL authenticates the operator 1000 if needed
    And POS QSR-FL-FL clicks on the test_ManagerScreen_RUPTURE
  ...
  Scenario: Mobile - Rupture scroll
    When user opens POS QSR-FL-FL in mobile
    And POS QSR-FL-FL clicks on the test_Header_MANAGER-MENU
    Then POS QSR-FL-FL authenticates the operator 1000 if needed
    And POS QSR-FL-FL clicks on the test_ManagerScreen_RUPTURE
  ...
  Scenario: Mobile - Rupture keyboard filter
    When user opens POS QSR-FL-FL in mobile
    And POS QSR-FL-FL clicks on the test_Header_MANAGER-MENU
    Then POS QSR-FL-FL authenticates the operator 1000 if needed
    And POS QSR-FL-FL clicks on the test_ManagerScreen_RUPTURE
