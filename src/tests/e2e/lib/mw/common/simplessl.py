# Embedded file name: C:\Program Files\OpenSSH\gitlabci\mwapp\src\wrappers\python\simplessl.py
"""
...
_funcdefs = (('simplessl_create', c_int32, (c_void_pp, c_char_p, c_uint32)),
 ('simplessl_setcertificate', c_int32, (c_void_p,
   c_char_p,
   c_int32,
   c_char_p,
   c_int32,
   c_char_p,
   c_uint32)),
 ('simplessl_connect', c_int32, (c_void_p,
   c_char_p,
   c_int32,
   c_char_p,
   c_uint32)),
 ('simplessl_write', c_int32, (c_void_p,
   c_char_p,
   c_uint32,
   c_char_p,
   c_uint32)),
 ('simplessl_readall', c_int32, (c_void_p,
   st_SimpleSSLData_pp,
   c_char_p,
   c_uint32)),
...
def _init_dll():
    ...
    for name, restype, argtypes in _funcdefs:
        ...
        if func is None:
            raise ImportError("Could not find function '%s' on 'simplessl' library." % name)
...
class SimpleSSL:
    ...
    def setcertificate(self, cert, key):
        ...
        self._call('simplessl_setcertificate', self._pconn, cert, szcert, key, szkey)
