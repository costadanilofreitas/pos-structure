...
class Configurator(object):
    ...
    def _get_user_configurations(self, loader_cfg):
        ...
        user.active_frequency = int(configurator_reader.get_configuration("ActiveFrequency") or "0")
    ...
    def _get_loader_configurations(self, loader_cfg):
        ...
        loader.active_frequency = int(configurator_reader.get_configuration("ActiveFrequency") or "0")

        start_time = configurator_reader.get_configuration(self.window_start_time) or "00:00:00"
        loader.window.start_time = datetime.strptime(start_time, "%H:%M:%S").time()
        end_time = configurator_reader.get_configuration(self.window_end_time) or "00:00:00"
